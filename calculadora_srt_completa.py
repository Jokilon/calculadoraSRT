...
def obtener_ripte_actual():
    try:
        ...
        headers = {"Authorization": "BEARER eyJhbGciOiJIUzUxMiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3ODI4NDMyNjMsInR5cGUiOiJleHRlcm5hbCIsInVzZXIiOiJiYWxhZG9hYm9nYWRvc0BnbWFpbC5jb20ifQ.k41Nvmqs3RLiuQz7mF-KvFfnwipS-JJi7UOadVmf7lqwuVtc5tpb83wOd176W4_D-VRJBpuCP1IE9rR4y7EF-A"}
        r = requests.get(url, headers=headers)
        if r.status_code == 200:
            datos = r.json()
            return float(datos[-1]['valor'])
    except:
        pass
    return 1.0
